...
#define SYSTICK_CLK_SRC_CLR()            (SYSTICK->CSR &= ~(1<<SYST_CSR_CLKSOURCE))
#define SYSTICK_GET_CLK_SRC()            ((SYSTICK->CSR & 1<<SYST_CSR_CLKSOURCE)>>SYST_CSR_CLKSOURCE)
#define SYSTICK_CLK_SRC_SET(x)           do{ \
                                            if(x == SYSTICK_CLK_SRC_AHB_DIV_8) \
                                                SYSTICK_CLK_SRC_CLR(); \
                                            else \
