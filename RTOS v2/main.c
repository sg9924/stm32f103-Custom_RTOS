...
int main(void)
{
    ...
    //task_handle[1] = taskAdd_Weighted(&task2, "Task 2", 2);
    //task_handle[2] = taskAdd_Weighted(&task3, "Task 3", 5);

    //Add the tasks
    //task_handle[0] = taskAdd(&task1, "Task 1");
    //task_handle[1] = taskAdd(&task2, "Task 2");
