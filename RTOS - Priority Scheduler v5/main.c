...
void task1(void)
{
    while(1)
    {
        Serialprintln("[Tick: %x] [ID: %d] [Priority: %d] Task 1", INFO, Systick_get_tick(), task[0]->task_id, task[0]->task_priority);
...
void task2(void)
{
    while(1)
    {
        Serialprintln("[Tick: %x] [ID: %d] [Priority: %d] Task 2", INFO, Systick_get_tick(), task[1]->task_id, task[1]->task_priority);
...
void task3(void)
{
    while(1)
    {
        Serialprintln("[Tick: %x] [ID: %d] [Priority: %d] Task 3", INFO, Systick_get_tick(), task[2]->task_id, task[2]->task_priority);
